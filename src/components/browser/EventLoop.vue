...
<template>
  <section>
    ...
    <img src="@/assets/event-loop.svg" width="600" style="object-fit: contain;padding:20px;border:1px solid #eee;margin-bottom: 16px;">
    ...
    <strong>Observer属于微任务,且优先级小于Promise,</strong>参考来源<a href="https://zhuanlan.zhihu.com/p/482144072">浏览器的五种观察者模式</a>
