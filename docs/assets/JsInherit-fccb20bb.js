import{d as g,b as a,c as m,e as _,f as t,w as i,u as e,g as n}from"./index-2da9ee8b.js";const s=`// 1.原型链继承
function Parent () {
  this.name = 'parent'
}
...
// 推荐: ES6的class > 组合式 > 其他
`,f=n("h2",null,"1.原型链继承",-1),y=n("h2",null,"2.构造函数继承",-1),C=n("h2",null,"3.组合(原型链+ 构造)继承",-1),H=n("p",null," 这个也称作经典继承",-1),j=n("h2",null,"4.原型式继承",-1),x=n("h2",null,"5.寄生式继承",-1),P=n("h2",null,"6.ES6的class继承",-1),v=g({__name:"JsInherit",setup(w){return(S,b)=>{const u=a("page-header"),o=a("highlightjs"),c=a("CopyWrapper");return m(),_("section",null,[t(u,{title:"JS的继承",description:"网上的普遍分类,JS有六种继承方式"}),f,t(c,{msg:e(s)},{default:i(()=>[t(o,{language:"javascript",code:e(s)},null,8,["code"])]),_:1},8,["msg"]),y,t(c,{msg:e(l)},{default:i(()=>[t(o,{language:"javascript",code:e(l)},null,8,["code"])]),_:1},8,["msg"]),C,H,t(c,{msg:e(r)},{default:i(()=>[t(o,{language:"javascript",code:e(r)},null,8,["code"])]),_:1},8,["msg"]),j,t(c,{msg:e(h)},{default:i(()=>[t(o,{language:"javascript",code:e(h)},null,8,["code"])]),_:1},8,["msg"]),x,t(c,{msg:e(d)},{default:i(()=>[t(o,{language:"javascript",code:e(d)},null,8,["code"])]),_:1},8,["msg"]),P,t(c,{msg:e(p)},{default:i(()=>[t(o,{language:"javascript",code:e(p)},null,8,["code"])]),_:1},8,["msg"])])}}});export{v as default};
