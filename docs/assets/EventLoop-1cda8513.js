import{_ as a}from"./PageHeader.vue_vue_type_script_setup_true_lang-6a102bba.js";import{d as n,b as r,c as i,e,h as s,u as l,U as c,f as o,g as d}from"./index-b7e0e228.js";const u="/assets/eventLoop-03959c1b.png",p=`
  // 研究事件循环的代码
...
`,g=c('<h2>消息队列</h2><p>一个个任务放到消息队列里面依次执行,在<strong>消息队列</strong>里面的任务称为<strong>宏任务</strong>,为了让优先级更高的新任务更快的执行,浏览器又为每个宏任务建立了一个<strong>微任务队列</strong>,当前宏任务执行完毕后,先看当前宏任务的微任务队列里面是否有微任务要执行,有的话先把微任务执行完毕,再执行下一个宏任务</p><img src="'+u+'" width="800" style="object-fit:contain;"><h2>微任务</h2><ol>浏览器提供了五种Observer来监听页面变化 <li><code>MutationObserver</code></li><li><code>IntersectionObserver</code></li><li><code>PerformanceObserver</code></li><li><code>ResizeObserver</code></li><li><code>ReportingObderver</code></li></ol>',5),b=o("a",{link:"https://zhuanlan.zhihu.com/p/482144072"},"浏览器的五种观察者模式",-1),x=o("p",null,"研究事件循环和闭包的参考代码,可以用开发者工具调试,注意查看调用栈",-1),j=n({__name:"EventLoop",setup(h){return(m,_)=>{const t=r("highlightjs");return d(),i("section",null,[e(a,{title:"事件循环",description:"浏览器上会发生很多事件,如IO输入、按钮点击、屏幕缩放等等,浏览器需要有个调度机制让这些事件有条不紊地顺序执行,这个调度机制就是事件循环。"}),g,s(" Observer属于微任务,且优先级小于Promise,参考来源"),b,x,e(t,{language:"js",code:l(p)},null,8,["code"])])}}});export{j as default};
